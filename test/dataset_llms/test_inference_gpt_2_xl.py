import unittest
from src.dataset_llms import InferenceGPT2XL
from test.dataset_llms import TestInferenceLLM


class TestInferenceGPT2XL(TestInferenceLLM):
    """
    Tests the functionality of the InferenceGPT2XL class. Inherits most of its test from TestInferenceLLM, changing
