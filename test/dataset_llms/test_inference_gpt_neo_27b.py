import unittest
from src.dataset_llms import InferenceGPTNeo27B
from test.dataset_llms import TestInferenceLLM


class TestInferenceGPTNeo27B(TestInferenceLLM):
    """
    Tests the functionality of the InferenceGPTNeo27B class. Inherits most of its test from TestInferenceLLM, changing
