import unittest
from src.dataset_llms import InferenceGPTNeo13B
from test.dataset_llms import TestInferenceLLM


class TestInferenceGPTNeo13B(TestInferenceLLM):
    """
    Tests the functionality of the InferenceGPT13B class. Inherits most of its test from TestInferenceLLM, changing
