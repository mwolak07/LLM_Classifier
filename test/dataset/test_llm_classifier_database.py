...
class TestLLMClassifierDatabase(unittest.TestCase):
    ...
    """
    mock_dataset_file: str = 'mock_ms_marco_data.json'
    ...
    def test_add_ms_marco_dataset_short_prompts(self):
        ...
        expected_rows = [
            ...
            LLMClassifierRow(dataset[4].query, dataset[4].chosen_passages, None, dataset[4].answers[1], None, True),
            ...
            LLMClassifierRow(dataset[10].query, dataset[10].chosen_passages, None, dataset[10].answers[0], None, True),
        ]
    ...
    def test_add_ms_marco_dataset_long_prompts(self):
        ...
        expected_rows = [
            ...
            LLMClassifierRow(dataset[2].query, dataset[2].passages, None, None, None, False),
            ...
            LLMClassifierRow(dataset[4].query, dataset[4].passages, None, dataset[4].answers[1], None, True),
            ...
            LLMClassifierRow(dataset[10].query, dataset[10].passages, None, dataset[10].answers[0], None, True),
        ]
        db_rows = [row for row in self.db]
        for i in range(len(self.db)):
            self.assertEqual(expected_rows[i], db_rows[i])
    ...
    def test_human_answers(self):
        ...
        answers = [
            "One where each employee is treated fairly, regardless of work experience, time with the company, gender, "
            "cultural background or any other distinguishing factor.",
            "A respectful workplace is one where each employee is treated fairly, regardless of work experience, time "
            "with the company, gender, cultural background or any other distinguishing factor.",
            "HCG, Human Chorionic Gonadotropin levels disappear after birth within 24 to 36 hours.",
            "Human chorionic gonadotropin levels disappeared from 24 to 36 hours after a birth.",
            "The North Sea is a marginal sea of the Atlantic Ocean located between Great Britain, Scandinavia, Germany,"
            " the Netherlands, Belgium, and France.",
            "Matic plays Midfield.",
            "The final inspection of a home by the buyers before it's sold.",
            "The North Sea is a marginal sea of the Atlantic Ocean located between Great Britain, Scandinavia, Germany,"
            " the Netherlands, Belgium, and France.",
            "Matic plays Midfield.",
            "The final inspection of a home by the buyers before it's sold.",
