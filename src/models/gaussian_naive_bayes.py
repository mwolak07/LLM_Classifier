...
def train(model: GaussianNB, x: ndarray[ndarray[ndarray[np.float16]]], y: ndarray[int], batch_size: int) -> GaussianNB:
    """
...
def test(model: GaussianNB, x: ndarray[ndarray[ndarray[np.float16]]], y: ndarray[int]) -> None:
    """
...
def gaussian_naive_bayes(batch_size: int) -> None:
    """
...
if __name__ == '__main__':
    gaussian_naive_bayes(batch_size=256)
