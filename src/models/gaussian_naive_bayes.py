...
def train(model: GaussianNB, dataset: LLMClassifierDataset, max_words: int, batch_size: int) -> GaussianNB:
    """
...
def test(model: GaussianNB, dataset: LLMClassifierDataset, max_words: int, batch_size: int) -> None:
    """
...
if __name__ == '__main__':
    gaussian_naive_bayes(batch_size=4096)
